...
Mandy Connectors provide REST APIs for integrating with external workshop management and booking systems. Each connector is a standalone microservice that handles authentication, data synchronization, and business operations for its target system.
